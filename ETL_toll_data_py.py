...
# Define the DAG
dag = DAG(
    dag_id='ETL_toll_data_py',
    default_args=default_args,
    description='ETL process for toll data',
...
BASE_PATH = '/home/project/airflow/dags/python_etl'
DESTINATION_PATH = os.path.join(BASE_PATH, 'staging')
source_file = os.path.join(BASE_PATH, 'toll_data.tgz')
vehicle_data = os.path.join(BASE_PATH, 'vehicle_data.csv')
tollplaza_data = os.path.join(BASE_PATH, 'tollplaza_data.tsv')
payment_data = os.path.join(BASE_PATH, 'payment_data.txt')
